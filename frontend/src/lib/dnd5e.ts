...
/** Three-letter display abbreviation keyed by full ability name (STR, DEX, …). */
...
/** Ability abbreviations in canonical order (STR, DEX, CON, INT, WIS, CHA). */
export const ABILITY_ABBREVIATIONS = ABILITY_NAMES.map((a) => ABILITY_LABELS[a]);
